<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="uploadHavaia.aspx.cs" Inherits="uploadHavaia" %>
...
<form name="form1" method="post" runat="server" onsubmit="return cheackAll();">
        ...
        <td> <input type="text" name="fn" id="fn" value="<%=Session["name"]%>" size="20px" style="width:96%; height:25px" /> </td>
 ...
 <td> <select name="tafkid" id="tafkid" style="font-size:20px;width:96%; height:25px" >
     ...
     <tr> 
     <td style="width:150px; height:20px" colspan="2" > החוויות שלי 
      <br />
