<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="signupWeb.aspx.cs" Inherits="signupWeb" %>
...
<form name="form1" method="post" runat="server" onsubmit="return cheackAll();">
    ...
    <tr> 
     <td style="width:150px; height:20px"> מייל </td> 
     <td>  <input type="text" name="email" id="email" size="20px" style="width:96%; height:25px" /> </td>
     <td id="emailErr"style="font-size:15px; font-family:'BN Dragon'; color:black" > </td>
    </tr>
     <tr> 
     <td style="width:150px; height:20px"> סיסמה </td> 
     <td>  <input type="password" name="pass" id="pass" size="20px" style="width:96%; height:25px" /> </td>
 ...
 <td> <select name="tafkid" id="tafkid" style="font-size:20px;width:96%; height:25px" >
         <option value="0" > בחר "מי אני"</option>
